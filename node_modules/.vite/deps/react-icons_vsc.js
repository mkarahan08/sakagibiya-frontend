...
function VscDiffMultiple(props) {
	return GenIcon({
		...
		"child": [{
			...
			"tag": "path",
			"attr": { "d": "M12.4199 0.999756L14.7099 3.28976L14.9999 3.99976L15 13.9998L14 14.9998L13.9999 3.99976L10.9999 0.999756H12.4199Z" },
			"child": []
		}]
	})(props);
}
...
function VscGoToEditingSession(props) {
	return GenIcon({
		...
		"child": [
			{
				"tag": "path",
				"attr": { "d": "M8 1.00006H3L2 2.00006V14.0001L3 15.0001H12L13 14.0001V6.81723H12V14.0001H3V2.00006H8V1.00006Z" },
				"child": []
			},
			{
				"tag": "path",
				"attr": { "d": "M8 4.00006H7.00006V6.00006H5.00006V7.00006H7.00006V9.00006H8.00006V7.00006H10.0001V6.00008L8.00006 6.00006L8 4.00006Z" },
				"child": []
			},
			{
				"tag": "path",
				"attr": { "d": "M5.00006 11.0001H10.0001V12.0001H5.00006V11.0001Z" },
				"child": []
			},
			{
				"tag": "path",
				"attr": { "d": "M13.8703 0.482666L14.3724 0.984712V4.52025H13.3683V2.18679L10.2287 5.32635L9.5216 4.61924L12.6682 1.47262L10.3348 1.47262L10.3348 0.482666L13.8703 0.482666Z" },
				"child": []
			}
		]
	})(props);
...
function VscLightbulbSparkle(props) {
	return GenIcon({
		...
		"child": [
			...
			{
				"tag": "path",
				"attr": { "d": "M12.926 13.2393C13.2849 12.977 13.5538 12.6663 13.7328 12.4216C13.8545 12.2553 14.1455 12.2553 14.2672 12.4216C14.4462 12.6663 14.7151 12.977 15.074 13.2393C15.2403 13.3609 15.2403 13.6393 15.074 13.7609C14.7151 14.0231 14.4462 14.3337 14.2672 14.5784C14.1455 14.7447 13.8545 14.7447 13.7328 14.5784C13.5538 14.3337 13.2849 14.0231 12.926 13.7609C12.7597 13.6393 12.7597 13.3609 12.926 13.2393Z" },
				"child": []
			}
		]
	})(props);
...
function VscScreenFull(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3 12h10V4H3v8zm2-6h6v4H5V6zM2 6H1V2.5l.5-.5H5v1H2v3zm13-3.5V6h-1V3h-3V2h3.5l.5.5zM14 10h1v3.5l-.5.5H11v-1h3v-3zM2 13h3v1H1.5l-.5-.5V10h1v3z" },
			"child": []
		}]
	})(props);
}
function VscScreenNormal(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M3.5 4H1V3h2V1h1v2.5l-.5.5zM13 3V1h-1v2.5l.5.5H15V3h-2zm-1 9.5V15h1v-2h2v-1h-2.5l-.5.5zM1 12v1h2v2h1v-2.5l-.5-.5H1zm11-1.5l-.5.5h-7l-.5-.5v-5l.5-.5h7l.5.5v5zM10 7H6v2h4V7z" },
			"child": []
		}]
	})(props);
}
function VscSearchFuzzy(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M8 1.5C5.51472 1.5 3.5 3.51472 3.5 6C3.5 7.20114 3.9706 8.29237 4.73749 9.09937L1.04291 12.7939L1.75001 13.5011L5.5053 9.74577C6.2193 10.2222 7.07721 10.5 8 10.5C10.4853 10.5 12.5 8.48528 12.5 6C12.5 3.51472 10.4853 1.5 8 1.5ZM4.5 6C4.5 4.067 6.067 2.5 8 2.5C9.933 2.5 11.5 4.067 11.5 6C11.5 7.933 9.933 9.5 8 9.5C6.067 9.5 4.5 7.933 4.5 6Z" },
			"child": []
		}, {
			"tag": "path",
			"attr": { "d": "M8.99998 13.8546L6.85353 16.0011H6.14642L4.64642 14.5011L5.35353 13.7939L6.49998 14.9404L8.64642 12.7939H9.35353L11.5 14.9404L13.6464 12.7939H14.3535L16 14.4404V15.8546L14 13.8546L11.8535 16.0011H11.1464L8.99998 13.8546Z" },
			"child": []
		}]
	})(props);
}
...
function VscSearch(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M15.25 0a8.25 8.25 0 0 0-6.18 13.72L1 22.88l1.12 1 8.05-9.12A8.251 8.251 0 1 0 15.25.01V0zm0 15a6.75 6.75 0 1 1 0-13.5 6.75 6.75 0 0 1 0 13.5z" },
			"child": []
		}]
	})(props);
}
...
function VscSplitHorizontal(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M14 1H3L2 2v11l1 1h11l1-1V2l-1-1zM8 13H3V2h5v11zm6 0H9V2h5v11z" },
			"child": []
		}]
	})(props);
}
function VscSplitVertical(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M14 1H3L2 2v11l1 1h11l1-1V2l-1-1zm0 12H3V8h11v5zm0-6H3V2h11v5z" },
			"child": []
		}]
	})(props);
}
...
function VscThumbsdownFilled(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M5.46 14.11a1.46 1.46 0 0 1-.81-.25 1.38 1.38 0 0 1-.45-1.69L5.17 10H2.38a1.36 1.36 0 0 1-1.16-.61 1.35 1.35 0 0 1-.09-1.32C1.8 6.62 3 4 3.4 2.9A1.38 1.38 0 0 1 4.69 2h8.93A1.4 1.4 0 0 1 15 3.4v3.51a1.38 1.38 0 0 1-1.38 1.38h-1.38L6.4 13.75a1.41 1.41 0 0 1-.94.36z" },
			"child": []
		}]
	})(props);
}
...
function VscThumbsupFilled(props) {
	return GenIcon({
		...
		"child": [{
			"tag": "path",
			"attr": { "d": "M10.54 2c.289.001.57.088.81.25a1.38 1.38 0 0 1 .45 1.69l-.97 2.17h2.79a1.36 1.36 0 0 1 1.16.61 1.35 1.35 0 0 1 .09 1.32c-.67 1.45-1.87 4.07-2.27 5.17a1.38 1.38 0 0 1-1.29.9H2.38A1.4 1.4 0 0 1 1 12.71V9.2a1.38 1.38 0 0 1 1.38-1.38h1.38L9.6 2.36a1.41 1.41 0 0 1 .94-.36z" },
			"child": []
		}]
	})(props);
}
